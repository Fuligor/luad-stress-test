...
def count_annotations_in_file(
    file_path: Path, xml_element: str = "Region", annot_attr: str = "Text"
) -> dict:
    ...
    return {"filename": file_path.name} | counts


def count_annotations_in_dir(
    dir_path, xml_element="Region", annot_attr="Text", return_sum=False
):
